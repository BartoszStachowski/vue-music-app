<template>
    <form @submit.prevent="handleRegister">
        <div class="mb-3">
            <AppInput v-model="name" label="Name<span class='text-red-500'>*</span>" placeholder="Enter Name" />
        </div>
        <div class="mb-3">
            <AppInput v-model="email" label="Email<span class='text-red-500'>*</span>" type="email"
        ...
        <div class="mb-3">
            <AppInput v-model="password" label="Password<span class='text-red-500'>*</span>" type="password"
                placeholder="Password" />
        </div>
        <div class="mb-3">
            <AppInput v-model="confirmPassword" label="Confirm Password<span class='text-red-500'>*</span>"
...
const handleRegister = async () => {
    ...
    if (validateCompareValues(obj.password, confirmPassword.value)) {
        return errorMsg.value = validateCompareValues(obj.password, confirmPassword.value, 'Confirm password')
    }
